...
class Jobify_Template_Assets {
    ...
    public function enqueue_scripts() {
        ...
        wp_enqueue_script( 'jobify', get_template_directory_uri() . '/js/jobify.min.js', $deps, 20170530, true );
    ...
    public function enqueue_styles() {
        ...
        wp_enqueue_style( 'jobify-parent', get_template_directory_uri() . '/style.css', array(), 20170108 );
