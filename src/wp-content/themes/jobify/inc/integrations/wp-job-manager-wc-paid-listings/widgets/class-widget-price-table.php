                ...
                <?php foreach ( $packages as $key => $package ) : $product = get_product( $package ); ?>
                    <div class="price-option">
                        ...
                        <div class="price-option__description">
                            ...
                            <p>
                                <a href="<?php echo esc_url( add_query_arg( 'selected_package', $product->id, $submit ) ); ?>" class="button button--type-action button--style-inverted"><?php _e( 'Get Started', 'jobify' ); ?></a>
                            </p>
                        </div>
                    </div>
