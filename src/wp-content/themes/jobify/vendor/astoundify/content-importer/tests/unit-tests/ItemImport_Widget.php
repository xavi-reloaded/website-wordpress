...
class Test_ItemImport_Widget extends WP_UnitTestCase {
	...
	public function test_import_ItemImport_Widget_returns_widget_settings_with_widgetized_sidebar() {
		...
		register_sidebar( array( 'id' => 'widget-area-page-' . $page_id, 'name' => 'Widgetized Sidebar' ) );
	...
	public function test_import_multiple_ItemImport_Widget() {
		...
		$expected_text = array( 1 => array( 'title' => 'Text Widget' ), 2 => array( 'title' => 'Text Widget' ), 3 => array( 'title' => 'Text Widget' ) );

		$rss = get_option( 'widget_rss' );
		$expected_rss = array( 1 => array( 'title' => 'RSS Widget' ), 2 => array( 'title' => 'RSS Widget' ) );
