...
/**
 * RestImpo theme specific functions and customizer.
 *  
*/    
// Set path to RestImpo theme specific functions
$restimpo_fe_path = get_template_directory() . '/functions/fe/';  
// Include Theme specific functionality [FE] 
require_once ($restimpo_fe_path . 'headerdata.php');
require_once ($restimpo_fe_path . 'library.php');
require_once ($restimpo_fe_path . 'widget-posts-default.php');
// Include Theme Customization admin screen  
require_once (get_template_directory() . '/functions/customizer.php');
// Include About RestImpo admin page 
...
function restimpo_scripts_styles() {
    ...
    if ( get_theme_mod('restimpo_display_scroll_top') != 'Hide' ) {
...
if (get_theme_mod('restimpo_excerpt_length') != '') {
return esc_attr(get_theme_mod('restimpo_excerpt_length'));
} else { return 30; }
}
