...
<head>
	...
	<?php } ?>
	<?php if(isset($wl_rcsm_options['upload_favicon'])) { $favicon_img = $wl_rcsm_options['upload_favicon']; } else $favicon_img = RCSM_PLUGIN_URL.'options/images/favicon.png'; ?>
	<link rel="icon" href="<?php echo $favicon_img; ?>">
