		...
		<?php while ( bbp_forums() ) : bbp_the_forum(); ?>
			...
			<div class="section-head gallery-title forum-cat">
				...
				<ul class="forum-titles">
					...
					<li class="normal bbp-forum-topic-count"><?php _ex('Topics', 'bbPress', 'flipmag'); ?> / <?php 
							bbp_show_lead_topic() ? _ex('Replies', 'bbPress', 'flipmag') : _ex('Posts', 'bbPress', 'flipmag'); ?></li>
					<li class="normal bbp-forum-freshness"><?php _ex('Freshness', 'bbPress', 'flipmag'); ?></li>
				</ul>
