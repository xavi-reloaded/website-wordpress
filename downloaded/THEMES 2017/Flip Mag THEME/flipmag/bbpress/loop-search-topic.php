...
<div <?php bbp_topic_class(0, 'single-post'); ?>>
	...
	<div class="bbp-reply-content">
		...
		<div class="reply-meta">
			<?php bbp_topic_author_link(array('type' => 'name')); ?> <?php _ex('on', 'bbPress Reply', 'flipmag'); ?> <span class="post-date"><?php bbp_topic_post_date(); ?></span>
			
			
		<?php if ( bbp_is_single_user_replies() ) : ?>

			<span>&middot; 
				<?php _ex('in reply to: ', 'bbPress', 'flipmag'); ?>
