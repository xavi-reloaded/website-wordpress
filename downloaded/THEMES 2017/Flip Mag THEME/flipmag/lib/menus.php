...
class Flipmag_Menus
{
	...
	public function init()
	{
		...
		$this->fields = apply_filters('flipmag_custom_menu_fields', array());
	...
	{
		include_once get_template_directory().'/lib/menu-walker-edit.php';
		
		return 'Flipmag_Menu_Edit_Walker'; 
	}
	...
	{	
		if ($args['walker'] == 'Flipmag_Menu_Walker') {
			
			include_once get_template_directory().'/lib/menu-walker.php';
			
			$args['walker'] = new Flipmag_Menu_Walker;
		}	
