...
class Flipmag_Block_17 extends SiteOrigin_Widget {
    ...
    function __construct() {
            parent::__construct(
                    'oc-block-17',
                    __('Block 17 - Flipmag', 'flipmag'),
                    array(
                            'description' => __('Display your posts as block 17 module.', 'flipmag'),
...
siteorigin_widget_register('oc-block-17', __FILE__, 'Flipmag_Block_17');