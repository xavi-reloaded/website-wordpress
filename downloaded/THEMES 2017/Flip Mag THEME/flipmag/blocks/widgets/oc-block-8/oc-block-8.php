...
class Flipmag_Block_8 extends SiteOrigin_Widget {
    ...
    function __construct() {
            parent::__construct(
                    'oc-block-8',
                    __('Block 8 - Flipmag', 'flipmag'),
                    array(
                            'description' => __('Display your posts as block 8 module.', 'flipmag'),
...
siteorigin_widget_register('oc-block-8', __FILE__, 'Flipmag_Block_8');