...
class Flipmag_Block_1 extends SiteOrigin_Widget {
    ...
    function __construct() {
            parent::__construct(
                    'oc-block-1',
                    __('Block 1 - Flipmag', 'flipmag'),
                    array(
                            'description' => __('Display your posts as block 1 module.', 'flipmag'),
...
siteorigin_widget_register('oc-block-1', __FILE__, 'Flipmag_Block_1' );