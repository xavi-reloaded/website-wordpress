...
class Flipmag_Block_16 extends SiteOrigin_Widget {
    ...
    function __construct() {
            parent::__construct(
                    'oc-block-16',
                    __('Block 16 - Flipmag', 'flipmag'),
                    array(
                            'description' => __('Display your posts as block 16 module.', 'flipmag'),
...
siteorigin_widget_register('oc-block-16', __FILE__, 'Flipmag_Block_16');