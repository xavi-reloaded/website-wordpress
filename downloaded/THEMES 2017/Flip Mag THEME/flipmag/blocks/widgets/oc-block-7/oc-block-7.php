...
class Flipmag_Block_7 extends SiteOrigin_Widget {
    ...
    function __construct() {
            parent::__construct(
                    'oc-block-7',
                    __('Block 7 - Flipmag', 'flipmag'),
                    array(
                            'description' => __('Display your posts as block 7 module.', 'flipmag'),
...
siteorigin_widget_register('oc-block-7', __FILE__, 'Flipmag_Block_7');