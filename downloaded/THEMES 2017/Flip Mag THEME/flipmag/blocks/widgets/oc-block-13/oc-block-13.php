...
class Flipmag_Block_13 extends SiteOrigin_Widget {
    ...
    function __construct() {
            parent::__construct(
                    'oc-block-13',
                    __('Block 13 - Flipmag', 'flipmag'),
                    array(
                            'description' => __('Display your posts as block 13 module.', 'flipmag'),
...
siteorigin_widget_register('oc-block-13', __FILE__, 'Flipmag_Block_13');