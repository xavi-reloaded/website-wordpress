...
class Flipmag_Block_6 extends SiteOrigin_Widget {
    ...
    function __construct() {
            parent::__construct(
                    'oc-block-6',
                    __('Block 6 - Flipmag', 'flipmag'),
                    array(
                            'description' => __('Display your posts as block 6 module.', 'flipmag'),
...
siteorigin_widget_register('oc-block-6', __FILE__, 'Flipmag_Block_6');