...
class Flipmag_Block_18 extends SiteOrigin_Widget {
    ...
    function __construct() {
            parent::__construct(
                    'oc-block-18',
                    __('Block 18 - Flipmag', 'flipmag'),
                    array(
                            'description' => __('Display your posts as block 18 module.', 'flipmag'),
...
siteorigin_widget_register('oc-block-18', __FILE__, 'Flipmag_Block_18');