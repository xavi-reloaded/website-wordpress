...
class Flipmag_Module_5 extends SiteOrigin_Widget {
    ...
    function __construct() {
            parent::__construct(
                    'oc-module-5',
                    __('Module 5 - Flipmag', 'flipmag'),
                    array(
                            'description' => __('Display your posts as 5 module.', 'flipmag'),
                    ...
                    array(
                            ...
                            'info' => array(
                                    'type' => 'error',
                                    'description' => __('Maximum 5 posts in one tab block and posts has thumbnail.', 'flipmag'),
                            ),
...
siteorigin_widget_register('oc-module-5', __FILE__, 'Flipmag_Module_5');