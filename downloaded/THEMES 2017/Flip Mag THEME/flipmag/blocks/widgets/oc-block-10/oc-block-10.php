...
class Flipmag_Block_10 extends SiteOrigin_Widget {
    ...
    function __construct() {
            parent::__construct(
                    'oc-block-10',
                    __('Block 10 - Flipmag', 'flipmag'),
                    array(
                            'description' => __('Display your posts as block 10 module.', 'flipmag'),
...
siteorigin_widget_register('oc-block-10', __FILE__, 'Flipmag_Block_10');