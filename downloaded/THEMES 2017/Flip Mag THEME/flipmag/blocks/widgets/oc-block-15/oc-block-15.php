...
class Flipmag_Block_15 extends SiteOrigin_Widget {
    ...
    function __construct() {
            parent::__construct(
                    'oc-block-15',
                    __('Block 15 - Flipmag', 'flipmag'),
                    array(
                            'description' => __('Display your posts as block 15 module.', 'flipmag'),
...
siteorigin_widget_register('oc-block-15', __FILE__, 'Flipmag_Block_15');