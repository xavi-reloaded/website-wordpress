...
class Flipmag_Block_5 extends SiteOrigin_Widget {
    ...
    function __construct() {
            parent::__construct(
                    'oc-block-5',
                    __('Block 5 - Flipmag', 'flipmag'),
                    array(
                            'description' => __('Display your posts as block 5 module.', 'flipmag'),
...
siteorigin_widget_register('oc-block-5', __FILE__, 'Flipmag_Block_5');