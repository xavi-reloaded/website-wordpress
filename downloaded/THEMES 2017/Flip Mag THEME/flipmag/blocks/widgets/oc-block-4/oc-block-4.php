...
class Flipmag_Block_4 extends SiteOrigin_Widget {
    ...
    function __construct() {
            parent::__construct(
                    'oc-block-4',
                    __('Block 4 - Flipmag', 'flipmag'),
                    array(
                            'description' => __('Display your posts as block 4 module.', 'flipmag'),
...
siteorigin_widget_register('oc-block-4', __FILE__, 'Flipmag_Block_4');