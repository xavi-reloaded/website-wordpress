...
class Flipmag_Block_14 extends SiteOrigin_Widget {
    ...
    function __construct() {
            parent::__construct(
                    'oc-block-14',
                    __('Block 14 - Flipmag', 'flipmag'),
                    array(
                            'description' => __('Display your posts as block 14 module.', 'flipmag'),
...
siteorigin_widget_register('oc-block-14', __FILE__, 'Flipmag_Block_14');