...
class Flipmag_Module_6 extends SiteOrigin_Widget {
    ...
    function __construct() {
            parent::__construct(
                    'oc-module-6',
                    __('Module 6 - Flipmag', 'flipmag'),
                    array(
                            'description' => __('Display your posts as module 6 module.', 'flipmag'),
...
siteorigin_widget_register('oc-module-6', __FILE__, 'Flipmag_Module_6');