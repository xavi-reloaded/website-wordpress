...
class Flipmag_Module_2 extends SiteOrigin_Widget {
    ...
    function __construct() {
            parent::__construct(
                    'oc-module-2',
                    __('Module 2 - Flipmag', 'flipmag'),
                    array(
                            'description' => __('Display your posts as module 2 module.', 'flipmag'),
                    ...
                    array(
                            ...
                            'controls' => array(
                                            ...
                                            'fields' => array(
                                                ...
                                                'thumb_size' => array(
                                                                'type' => 'select',
                                                                'label' => __('Choose Image Size', 'flipmag'),
                                                                'options' => array(
                                                                        'flipmag-main-block' => __(' Block (351 x 185)', 'flipmag'),
                                                                        'flipmag-main-slider' => __(' Slider (702 x 336)', 'flipmag'),
                                                                        'flipmag-main-full' => __('Full (1078 x 516)', 'flipmag'),                     
                                                                ),
                                                                'default' => 'normal',
                                                        ),
...
siteorigin_widget_register('oc-module-2', __FILE__, 'Flipmag_Module_2');