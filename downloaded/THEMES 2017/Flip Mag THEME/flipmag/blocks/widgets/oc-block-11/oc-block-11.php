...
class Flipmag_Block_11 extends SiteOrigin_Widget {
    ...
    function __construct() {
            parent::__construct(
                    'oc-block-11',
                    __('Block 11 - Flipmag', 'flipmag'),
                    array(
                            'description' => __('Display your posts as block 11 module.', 'flipmag'),
...
siteorigin_widget_register('oc-block-11', __FILE__, 'Flipmag_Block_11');