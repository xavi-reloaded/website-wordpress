...
class Flipmag_Block_2 extends SiteOrigin_Widget {
    ...
    function __construct() {
            parent::__construct(
                    'oc-block-2',
                    __('Block 2 - Flipmag', 'flipmag'),
                    array(
                            'description' => __('Display your posts as block 2 module.', 'flipmag'),
...
siteorigin_widget_register('oc-block-2', __FILE__, 'Flipmag_Block_2');