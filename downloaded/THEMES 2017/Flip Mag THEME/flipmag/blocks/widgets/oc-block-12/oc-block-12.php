...
class Flipmag_Block_12 extends SiteOrigin_Widget {
    ...
    function __construct() {
            parent::__construct(
                    'oc-block-12',
                    __('Block 12 - Flipmag', 'flipmag'),
                    array(
                            'description' => __('Display your posts as block 12 module.', 'flipmag'),
...
siteorigin_widget_register('oc-block-12', __FILE__, 'Flipmag_Block_12');