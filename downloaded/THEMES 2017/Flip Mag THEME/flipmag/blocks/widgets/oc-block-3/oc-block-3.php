...
class Flipmag_Block_3 extends SiteOrigin_Widget {
    ...
    function __construct() {
            parent::__construct(
                    'oc-block-3',
                    __('Block 3 - Flipmag', 'flipmag'),
                    array(
                            'description' => __('Display your posts as block 3 module.', 'flipmag'),
...
siteorigin_widget_register('oc-block-3', __FILE__, 'Flipmag_Block_3');