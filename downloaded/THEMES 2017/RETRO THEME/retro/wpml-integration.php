...
function wpml_content_languages( $args = '' ) {
	...
	if ( function_exists( 'icl_get_languages' ) ) {
		...
		if ( 1 < count( $languages ) ) {
			echo isset( $before ) ? $before : __( 'This post is also available in: ', 'retro' );
 ...
 * @return type
 */
if ( ! function_exists( 'wpml_page_id' ) ) {
 ...
 * @return type
 */
if ( ! function_exists( 'wpml_post_id' ) ) {
...
if ( ! function_exists( 'wpml_cat_id' ) ) {
