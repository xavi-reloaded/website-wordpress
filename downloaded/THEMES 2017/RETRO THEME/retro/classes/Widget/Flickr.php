...
HTML;
	...
	function form( $instance ) {
		...
		// Defaults
		$defaults = array( 'title' => __( 'Flickr', 'retro' ), 'number' => '4' );
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'user' ); ?>">
				<?php _e( 'Flickr ID', 'retro' ); ?> (<a href="http://www.idgettr.com" target="_blank">idGettr</a>) :
			</label>
			<input id="<?php echo $this->get_field_id( 'user' ); ?>" name="<?php echo $this->get_field_name( 'user' ); ?>" type="text" value="<?php $user = (isset( $instance['user'] )) ? $user = $instance['user'] : $user = null;
			echo $user; ?>" style="width:100%;" />
		</p>
