...
class Admin_Theme_SkinGroup_Footer_FooterSkin2 extends Admin_Theme_SkinGroup_ContentSkin2 {
	...
	protected function init() {
		...
		--------------------------------------*/
			...
			$option->setName( 'Footer pattern image' )
					...
					->setStd( get_template_directory_uri() . '/images/skin/skin2/footer-area-bg.png' );
			$this->addOptionToGroup( $option );
			$option = null;
			...
			$option->setName( 'Footer custom logo image' )
					...
					->setStd( get_template_directory_uri() . '/images/skin/skin2/logo-footer.png' );
			$this->addOptionToGroup( $option );
			$option = null;
