...
class Admin_Theme_SkinGroup_Footer_FooterSkin1 extends Admin_Theme_SkinGroup_ContentSkin1 {
	...
	protected function init() {
		...
		--------------------------------------*/
			...
			$option->setName( 'Footer pattern image' )
					...
					->setStd( get_template_directory_uri() . '/images/skin/skin1/footer-area-bg.png' );
			$this->addOptionToGroup( $option );
			$option = null;
			...
			$option->setName( 'Footer custom logo image' )
					...
					->setStd( get_template_directory_uri() . '/images/skin/skin1/logo-footer.png' );
			$this->addOptionToGroup( $option );
			$option = null;
