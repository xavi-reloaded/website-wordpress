...
class Admin_Theme_SkinGroup_Header_HeaderSkin1 extends Admin_Theme_SkinGroup_ContentSkin1 {
	...
	protected function init() {
		...
		--------------------------------------*/
			...
			$option->setName( 'Top tail pattern image' )
					...
					->setStd( get_template_directory_uri() . '/images/skin/skin1/top-pattern.png' );
			$this->addOptionToGroup( $option );
			$option = null;
			...
			$option->setName( 'Use custom logo image' )
					...
					->setStd( get_template_directory_uri() . '/images/skin/skin1/logo.png' );
			$this->addOptionToGroup( $option );
			$option = null;
			...
			$option->setName( 'Logo text color' )
					...
					->setId( SHORTNAME . '_logo_color_skin1' )
					->setStd( '#a4593a' );
			$this->addOptionToGroup( $option );
			...
			$option->setName( __( 'Logo text size', 'retro' ) )
					...
					->setId( SHORTNAME . '_logo_font_size_skin1' )
					->setStd( '47px' );
			$this->addOptionToGroup( $option );
			$option = null;
	}
