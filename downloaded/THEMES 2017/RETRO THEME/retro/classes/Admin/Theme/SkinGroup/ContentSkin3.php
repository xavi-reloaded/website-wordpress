...
class Admin_Theme_SkinGroup_ContentSkin3 extends Admin_Theme_Menu_SkinGroup {
	...
	protected function init() {
		...
		--------------------------------------*/
			...
			$option->setName( 'Body pattern image' )
					...
					->setStd( get_template_directory_uri() . '/images/skin/skin3/body-tail-1.png' );
			$this->addOptionToGroup( $option );
			$option = null;
			...
			$option->setName( 'Page pattern image' )
					...
					->setStd( get_template_directory_uri() . '/images/skin/skin3/content-pattern.png' );
			$this->addOptionToGroup( $option );
			$option = null;
