...
class Admin_Theme_SkinGroup_Footer_FooterSkin4 extends Admin_Theme_SkinGroup_ContentSkin4 {
	...
	protected function init() {
		...
		--------------------------------------*/
			...
			$option->setName( 'Footer pattern image' )
					...
					->setStd( get_template_directory_uri() . '/images/skin/skin4/footer-area-bg.png' );
			$this->addOptionToGroup( $option );
			$option = null;
			...
			$option->setName( 'Footer custom logo image' )
					...
					->setStd( get_template_directory_uri() . '/images/skin/skin4/logo-footer.png' );
			$this->addOptionToGroup( $option );
			$option = null;
