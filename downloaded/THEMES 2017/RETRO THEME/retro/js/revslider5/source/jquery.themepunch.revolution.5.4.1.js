...
!function ( jQuery, undefined ) {
    ...
    var _ISM = _R.is_mobile(),
        ...
        getNeededScripts = function ( a, b ) {
            ...
            _a.extensions_suffix = '.js'; // @todo remove for fix to minjs
            // END: retrowp
            return c.kenburns = !1,
                c.parallax = !1,
                c.carousel = !1,
                ...
                // START: retrowp
                c.navigation && "undefined" == typeof _R.createNavigation && lAjax( "revolution.extension.navigation.1.3.3", _a ),
                // END: retrowp
                ...
                p.addedyt = 0,
                    ...
                    if ( c.find( "iframe" ).each( function () {
                        ...
                        "row" !== q && "group" !== q && "column" !== q ? ( t = "display:" + c.css( "display" ) + ";", c.closest( ".rev_column" ).length > 0 ? ( c.addClass( "rev_layer_in_column" ), j = !1 ) : c.closest( ".rev_group" ).length > 0 && ( c.addClass( "rev_layer_in_group" ),
                            ...
                            "column" === q && ( c.append( '<div class="rev_column_bg rev_column_bg_man_sized" style="display:none"></div>' ), c.closest( ".tp-parallax-wrap" ).append( '<div class="rev_column_bg rev_column_bg_auto_sized"></div>' ) );
                    ...
                    x !== undefined && _R.checkActions( c, b, x ),
                        ...
                        !_ISM || _ANDROID && b.fallbacks.allowHTML5AutoPlayOnAndroid && g || ( 1 != e && "true" != e || ( d.autoplayonlyfirsttime = !1, e = !1 ), 1 != f && "true" != f && "on" != f && "1sttime" != f || ( d.autoplay = "off", f = "off" ) ),
