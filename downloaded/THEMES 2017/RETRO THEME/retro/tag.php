...
$post_sidebar = (get_tax_meta( $term->term_id, SHORTNAME . '_post_listing_sidebar', true )) ? get_tax_meta( $term->term_id, SHORTNAME . '_post_listing_sidebar', true ) : get_option( SHORTNAME . '_post_listing_sidebar' );
?>
<div class="row content-area clearfix">
	...
	<?php if ( $post_layout == 'layout_left_sidebar' ) { ?>
		<aside class="grid_4">
			<div class="left-sidebar"><?php $sidebar = ($post_sidebar) ? $post_sidebar : 'default-sidebar';
	...
	<?php if ( $post_layout == 'layout_right_sidebar' ) { ?>
		<aside class="grid_4">
			<div class="right-sidebar"><?php $sidebar = ($post_sidebar) ? $post_sidebar : 'default-sidebar';
			generated_dynamic_sidebar_th( $sidebar );
			?></div>
		</aside>
	<?php } ?>
