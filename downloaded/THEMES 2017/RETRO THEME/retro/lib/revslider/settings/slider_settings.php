<?php
				...
				'posts' => __( 'Posts',REVSLIDER_TEXTDOMAIN ),
				...
				if ( UniteEmRev::isEventsExists() ) {
					...
					$sliderMainSettings->addRadio('slider_type', array(
						'fixed' => __( 'Fixed',REVSLIDER_TEXTDOMAIN ),
					...
					'width' => 960,
					'height' => 350,
					'datatype' => UniteSettingsRev::DATATYPE_NUMBER,
					'description' => __('
