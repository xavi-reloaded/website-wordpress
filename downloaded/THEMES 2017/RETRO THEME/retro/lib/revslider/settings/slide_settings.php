...
if ( isset( $slider ) && $slider->isInited() ) {
	...
	// slot amount
	$params = array(
	'description' => __( 'The number of slots or boxes the slide is divided into. If you use boxfade, over 7 slots can be juggy.',REVSLIDER_TEXTDOMAIN ),
	'class' => 'small',
	'datatype' => 'number',
	);
	...
	// rotation:
	$params = array(
	'description' => __( 'Rotation (-720 -> 720, 999 = random) Only for Simple Transitions.',REVSLIDER_TEXTDOMAIN ),
	'class' => 'small',
	'datatype' => 'number',
	);
	...
	// transition speed
	$params = array(
	'description' => __( 'The duration of the transition (Default:300, min: 100 max 2000). ',REVSLIDER_TEXTDOMAIN ),
	'class' => 'small',
	'datatype' => 'number',
	);
	...
	// delay
	$params = array(
	'description' => __( 'A new delay value for the Slide. If no delay defined per slide, the delay defined via Options (',REVSLIDER_TEXTDOMAIN ) . $sliderDelay . __( 'ms) will be used',REVSLIDER_TEXTDOMAIN ),
	'class' => 'small',
	'datatype' => UniteSettingsRev::DATATYPE_NUMBEROREMTY,
	);
	$slideSettings->addTextBox( 'delay','',__( 'Delay',REVSLIDER_TEXTDOMAIN ), $params );

	$params = array(
	'description' => __( '',REVSLIDER_TEXTDOMAIN ),
	'class' => 'small',
	);
