...
class RevSliderSettingsProduct extends UniteSettingsRevProductRev{
	 ...
	 */
	public static function setSettingsCustomValues( $settings, $arrValues, $postTypesWithCats ) {
	 ...
	 */
	public static function setCategoryByPostTypes( $settings, $arrValues, $postTypesWithCats, $nameType, $nameCat, $defaultType ) {
		...
		if ( strpos( $postTypes, ',' ) !== false ) {
			$postTypes = explode( ',',$postTypes ); } else {
