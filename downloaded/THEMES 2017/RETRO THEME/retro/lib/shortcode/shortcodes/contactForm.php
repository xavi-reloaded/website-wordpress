...
<title><?php _e( 'Contact form','retro' ); ?></title>
...
<script type="text/javascript">
	...
	var ajax_nonce_shortcode = '<?php echo wp_create_nonce( 'ox_contactform_shortcode' ); ?>';
	var ajax_nonce_json = '<?php echo wp_create_nonce( 'ox_contactform_shortcode_to_json' ); ?>';
</script>
...
<style>
	...
	.fb-right { position: absolute; left: 428px; top: 220px; width: 315px; margin: 57px 21px 0 0; }
	...
	#sortable {width:322px; }
	input[type='checkbox'] + label.fb-radio-label {
		width: 275px;
	}
</style>
</head>
...
<body  onload="init();">
	<div id="media-upload-header">
		<div id="fb-success" class="fb-success" style="display: none;"><?php _e( 'Your new field was saved successfully','retro' ); ?></div>
	</div>
	<div class="fb-right">

		<div id="fb-add-field" style="display: none;">
			<h3><?php _e( 'Edit this new field','retro' ); ?></h3>
			<label for="fb-new-label"><?php _e( 'Label','retro' ); ?></label>
			<input type="text" id="fb-new-label" value="<?php _e( 'New field','retro' ); ?>" />
			<label for="fb-new-label"><?php _e( 'Field type','retro' ); ?></label>
			<select id="fb-new-type">
				<option value="checkbox"><?php _e( 'Checkbox','retro' ); ?></option>
				<option value="select"><?php _e( 'Drop down','retro' ); ?></option>
				<option value="email"><?php _e( 'Email','retro' ); ?></option>
				<option value="name"><?php _e( 'Name','retro' ); ?></option>
				<option value="radio"><?php _e( 'Radio','retro' ); ?></option>
				<option value="text" selected="selected"><?php _e( 'Text','retro' ); ?></option>
				<option value="textarea"><?php _e( 'Textarea','retro' ); ?></option>
				<option value="url"><?php _e( 'Website','retro' ); ?></option>
			</select>
			<div class="clear"></div>

			<div id="fb-options" style="display: none;">
				<div id="fb-new-options">
					<label for="fb-option0"><?php _e( 'Options','retro' ); ?></label>
					<input type="text" id="fb-option0" optionid="0" value="<?php _e( 'First option','retro' ); ?>" class="fb-options" />
				</div>
				<div id="fb-add-option" class="fb-add-option">
					<a href="#" id="fb-another-option"><?php _e( 'Add another option','retro' ); ?></a>
				</div>
			</div>
			...
			<div class="fb-required">
				...
				<label for="fb-new-label" class="fb-radio-label"><?php _e( 'Required?','retro' ); ?></label>
				<div class="clear"></div>
			</div>
			<div id="fb-reply" style="display: none;">
				<label for="fb-new-label"></label>
				<input type="checkbox" id="fb-new-reply" />
				<label for="fb-new-label" class="fb-radio-label"><?php _e( 'Use for reply?','retro' ); ?></label>
				<div class="clear"></div>
			</div>

			<input type="hidden" id="fb-field-id" />
			<input type="submit" class="button" value="<?php _e( 'Save this field','retro' ); ?>" id="fb-save-field" name="save">
		</div>
	</div>
	<form id="fb-preview">
		<div id="fb-add-field" class="fb-container" style="float:left">
			<h1><?php _e( "Here's what your form will look like",'retro' ); ?></h1>
			<div id="sortable" class="fb-form-case">

				<div id="fb-extra-fields" class="fb-extra-fields"></div>

				<a href="#" id="fb-new-field" class="fb-add-field"><?php _e( 'Add a new field','retro' ); ?></a>
			</div>

			<input type="submit" class="button-primary" tabindex="4" value="<?php _e( 'Add this form to my post','retro' ); ?>" id="fb-save-form" name="save">
		</div>
		<div id="fb-email-settings" class="fb-container" style="float: left;">
			<h1><?php _e( 'Email settings','retro' ); ?></h1>
			<div class="fb-form-case fb-settings">
				<label for="fb-fieldname"><?php _e( 'Enter your email address','retro' ); ?></label>
				<input type="text" id="fb-field-my-email" style="background: #FFF !important;" />

				<label for="fb-fieldemail" style="margin-top: 14px;"><?php _e( 'What should the subject line be?','retro' ); ?></label>
				<input type="text" id="fb-field-subject" style="background: #FFF !important;" />

				<label fieldid="sendbutton" for="fb-sendbutton" style="margin-top: 14px;"><?php _e( 'Send button text', 'retro' );?></label>
				<input type="text" id="fb-sendbutton" style="background: #FFF !important;" value="">

				<label fieldid="captcha" for="fb-captcha" style="margin-top: 14px;"><?php _e( 'Use reCaptcha(Public&Private keys must be set)', 'retro' );?></label>
				<input type="checkbox" id="fb-captcha" style="background: #FFF !important; float: none" value=""><span style="color: #AAA; padding-left:10px; "><?php _e( 'Theme Options -> reCaptcha', 'retro' ); ?></span>
			</div>
