...
class cmb_Meta_Box
{
	...
	function add_for_id( $display, $meta_box ) {
		...
		if ( isset( $_GET['post'] ) ) {
			$post_id = $_GET['post']; } elseif ( isset( $_POST['post_ID'] ) ) {
				...
				case 'portfolio':
                                                ...
                                                <div>
                                                    <div class="tabs-content">
                                                        <div class="slide-type image">
                                                            <div class="ox-field">
                                                                <div class="hndle ox-drag-order"><div><span></span></div></div>
																<div class="image-preview" ><div style="background-image:url(' . $slide_img_src . ')"></div></div>                                                              <div class="meta-image-input">
																	<input type="text" name="slide-img-src[]" class="image-url" size="30" value="' . $slide_img_src . '">
																	<input type="button" name="upload-image" class="upload-image button-secondary" value="' . __( 'Upload Image', 'retro' ) . '">
																	<button class="remove-slide button-secondary">' . __( 'Remove Slide', 'retro' ) . '</button>
                                                ...
                                                <div>
                                                    <div class="tabs-content">
                                                        <div class="slide-type image">
                                                            <div class="ox-field">
                                                                <div class="hndle ox-drag-order"><div><span></span></div></div>
                                                                <div class="image-preview" ><div style="background-image:url()"></div></div>                                                                <div class="meta-image-input">
                                                                    <input type="text" name="slide-img-src[]" class="image-url" size="30" value="">
																	<input type="button" name="upload-image" class="upload-image button-secondary" value="' . __( 'Upload Image', 'retro' ) . '">
																	<button class="remove-slide button-secondary">' . __( 'Remove Slide', 'retro' ) . '</button>
																	<input type="hidden" name="' . $field['id'] . '[]" size="30" value="">
                                                                </div>                                                              
					...
					$html .= '</ul>
                                  <div class="image-label">
									<button id="add-slider-slide" class="button-primary">' . __( 'Add New Slide', 'retro' ) . '</button>
                                  </div>
...
function cmb_scripts( $hook ) {
	if ( $hook == 'post.php' || $hook == 'post-new.php' || $hook == 'page-new.php' || $hook == 'page.php' ) {
		wp_register_script( 'cmb-timepicker', get_template_directory_uri() . '/lib/metabox/js/jquery.timePicker.min.js' );
		// wp_register_script( 'cmb-timepicker', CMB_META_BOX_URL . 'js/jquery.timePicker.min.js' );
		/**
		 * @todo !!important return constant
		 */
		...
		wp_register_script( 'cmb-scripts', get_template_directory_uri() . '/lib/metabox/js/cmb.js', array( 'jquery', 'jquery-ui-core', 'jquery-ui-datepicker', 'media-upload', 'thickbox', 'farbtastic' ) );
		wp_enqueue_script( 'cmb-timepicker' );
		wp_enqueue_script( 'cmb-scripts' );
		wp_register_style( 'cmb-styles', get_template_directory_uri() . '/lib/metabox/style.css', array( 'thickbox', 'farbtastic' ) );
