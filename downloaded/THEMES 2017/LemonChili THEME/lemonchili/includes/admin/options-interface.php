    ...
    $counter = 0;
        ...
        foreach ($options as $value) {
                ...
                case "info":
                        ...
                        $output .= '<div class="' . esc_attr( $class ) . '">' . "\n";
                        if ( isset($value['name']) ) {
                                $output .= '<h3 class="section-info">' . esc_html( $value['name'] ) . '</h3>' . "\n";
                        }
                        if ( isset ( $value['desc'] ) ) {
                ...
                case "heading":
                                ...
                                $image_link = $bloginfo_link . esc_url( $value['img'] ) ;
                        ...
                        $menu .= '<li><a title="' . esc_attr( $value['name'] ) . '" href="' . esc_attr( '#'.  $jquery_click_hook ) . '">' . '<img src=" ' . esc_url( $image_link ) . ' " />' . ' ' . esc_html( $value['name'] ) . ' <span class="kl"> settings </span>' . '</a></li>';
                ...
                if ( ( $value['type'] != "heading" ) && ( $value['type'] != "info" ) ) {
                        ...
                        $bloginfo_link = get_template_directory_uri();
                        $ico = $bloginfo_link . '/includes/admin/images/transparent.png' ;



                        $output .= '<div class="explain">'
                                   . '<a href="#" class="tip_trigger"> ' . '<img src="' . $ico .' " /> ' . ' <span class="tip"> ' . wp_kses( $explain_value, $allowedtags) . ' </span> </a> '
                                   . '</div>' ;
                        }
                        $output .= "\n";
