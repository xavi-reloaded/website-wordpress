...
$options[] = array(	"name" => _x('Margins for pages, posts & templates', 'theme-options', 'the7mk2'), "type" => "block" );
...
$options['general-page_content_top_margin'] = array(
	'name' => _x( 'Top (px)', 'theme-options', 'the7mk2' ),
	'id' => 'general-page_content_top_margin',
	'std' => '50',
	'type' => 'text',
	"class"	=> "mini",
	'sanitize' => 'dimensions',
...
$options['general-page_content_bottom_margin'] = array(
	'name' => _x( 'Bottom (px)', 'theme-options', 'the7mk2' ),
	'id' => 'general-page_content_bottom_margin',
	'std' => '50',
	'type' => 'text',
	"class"	=> "mini",
	'sanitize' => 'dimensions',
 ...
 * Images speed resize.
 */
$options[] = array(	"name" => _x('Images speed resize', 'theme-options', 'the7mk2') . ' (BETA)', "type" => "block" );

$options['advanced-speed_img_resize'] = array(
	"id"		=> 'advanced-speed_img_resize',
	"name"		=> _x('Images speed resize', 'theme-options', 'the7mk2'),
	"desc"		=> _x('BETA feature. Can reduce page load time. Not recommended.', 'theme-options', 'the7mk2'),
	"std"		=> '0',
	"type"		=> 'radio',
	"options"	=> array(
		'1' => _x('Enabled', 'theme-options', 'the7mk2'),
