...
$options[] = array( 'name' => _x( 'Microwidgets', 'theme-options', 'the7mk2' ), 'type' => 'heading' );
	...
	$options[] = array( 'name' => _x( 'Menu 1', 'theme-options', 'the7mk2' ), 'id' => 'microwidgets-custom_menu-block', 'class' => 'block-disabled', 'type' => 'block' );
	...
	$options[] = array( 'name' => _x( 'Menu 2', 'theme-options', 'the7mk2' ), 'id' => 'microwidgets-menu2-block', 'class' => 'block-disabled', 'type' => 'block' );
