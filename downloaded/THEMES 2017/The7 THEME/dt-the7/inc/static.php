...
if ( ! function_exists( 'presscore_enqueue_scripts' ) ) :
	...
	function presscore_enqueue_scripts() {
		...
		if ( locate_template( 'fonts/icomoon-arrows-the7/style.css', false ) ) {
			presscore_enqueue_theme_stylesheet( 'dt-arrow-icons', 'fonts/icomoon-arrows-the7/style' );
		}
		...
		if ( dt_is_legacy_mode() ) {
			presscore_enqueue_theme_script( 'dt-legacy', 'js/legacy', array( 'jquery' ), false, true );
        }
