...
function optionsframework_load_scripts($hook) {
	...
	wp_enqueue_script( 'options-custom', OPTIONS_FRAMEWORK_URL . 'js/options-custom.js', array( 'jquery', 'wp-color-picker', 'thickbox', 'options-select2', 'jquery-ui-core', 'jquery-ui-dialog', 'jquery-ui-slider', 'jquery-ui-widget', 'jquery-ui-sortable', 'jquery-form' ), $theme_version, true );
