...
function presscore_action_add_less_vars( $less_vars ) {
	...
	$less_vars->add_pixel_or_percent_number(
		...
		of_get_option( 'page_title-padding-top' )
	);

	$less_vars->add_pixel_or_percent_number(
		'page-title-bottom-padding',
		of_get_option( 'page_title-padding-bottom' )
	);
	...
	$less_vars->add_pixel_number(
		'page-top-margin',
		of_get_option( 'general-page_content_top_margin' )
	);

	$less_vars->add_pixel_number(
		'page-bottom-margin',
		of_get_option( 'general-page_content_bottom_margin' )
	);
	...
	$less_vars->add_rgba_color(
		...
		of_get_option( 'breadcrumbs_bg_opacity' )
	);
	// paddings
	// $less_vars->add_pixel_or_percent_number(
	// 	'breadcrumbs-padding',
	// 	of_get_option( 'breadcrumbs_padding', '10px' )
	// );
	$less_vars->add_pixel_or_percent_number(
		'breadcrumbs-padding-left',
		of_get_option( 'breadcrumbs_padding-left', '10px' )
	);

	$less_vars->add_pixel_or_percent_number(
		'breadcrumbs-padding-right',
		of_get_option( 'breadcrumbs_padding-right', '10px' )
	);

	$less_vars->add_pixel_or_percent_number(
		'breadcrumbs-padding-top',
		of_get_option( 'breadcrumbs_padding-top', '4px' )
	);

	$less_vars->add_pixel_or_percent_number(
		'breadcrumbs-padding-bottom',
		of_get_option( 'breadcrumbs_padding-bottom', '4px' )
	);

	//Margins
	$less_vars->add_pixel_or_percent_number(
		'breadcrumbs-margin-left',
		of_get_option( 'breadcrumbs_margin-left', '0px' )
	);

	$less_vars->add_pixel_or_percent_number(
		'breadcrumbs-margin-right',
		of_get_option( 'breadcrumbs_margin-right', '0px' )
	);

	$less_vars->add_pixel_or_percent_number(
		'breadcrumbs-margin-top',
		of_get_option( 'breadcrumbs_margin-top', '0px' )
	);

	$less_vars->add_pixel_or_percent_number(
		'breadcrumbs-margin-bottom',
		of_get_option( 'breadcrumbs_margin-bottom', '0px' )
	);
	$less_vars->add_pixel_number(
	...
	$less_vars->add_rgba_color(
		...
		of_get_option( 'breadcrumbs_border_opacity' )
	);
	...
	$less_vars->add_rgba_color(
		...
		of_get_option( 'general-title_bg_overlay_opacity' )
	);
	$less_vars->add_rgba_color(
		'title-outline-color',
	...
	$less_vars->add_rgba_color(
		...
		of_get_option( 'general-title_decoration_line_opacity' )
	);
	$less_vars->add_pixel_number(
	...
	if ( function_exists( 'presscore_themeoptions_get_buttons_defaults' ) ) {
		...
		foreach ( presscore_themeoptions_get_buttons_defaults() as $id=>$opts ) {
			...
			$less_vars->add_pixel_number(
				'btn-s-padding-left',
				of_get_option( 'buttons-s_padding-left', '14' )
			);

			$less_vars->add_pixel_number(
				'btn-s-padding-right',
				of_get_option( 'buttons-s_padding-right', '14' )
			);

			$less_vars->add_pixel_number(
				'btn-s-padding-top',
				of_get_option( 'buttons-s_padding-top', '8' )
			);

			$less_vars->add_pixel_number(
				'btn-s-padding-bottom',
				of_get_option( 'buttons-s_padding-bottom', '7' )
			);


			$less_vars->add_pixel_number(
				'btn-m-padding-left',
				of_get_option( 'buttons-m_padding-left', '18' )
			);

			$less_vars->add_pixel_number(
				'btn-m-padding-right',
				of_get_option( 'buttons-m_padding-right', '18' )
			);

			$less_vars->add_pixel_number(
				'btn-m-padding-top',
				of_get_option( 'buttons-m_padding-top', '12' )
			);

			$less_vars->add_pixel_number(
				'btn-m-padding-bottom',
				of_get_option( 'buttons-m_padding-bottom', '11' )
			);

			$less_vars->add_pixel_number(
				'btn-l-padding-left',
				of_get_option( 'buttons-l_padding-left', '24' )
			);

			$less_vars->add_pixel_number(
				'btn-l-padding-right',
				of_get_option( 'buttons-l_padding-right', '24' )
			);

			$less_vars->add_pixel_number(
				'btn-l-padding-top',
				of_get_option( 'buttons-l_padding-top', '17' )
			);

			$less_vars->add_pixel_number(
				'btn-l-padding-bottom',
				of_get_option( 'buttons-l_padding-bottom', '16' )
			);
	...
	$less_vars->add_rgba_color(
		...
		of_get_option( 'input_border_opacity' )
	);
	$less_vars->add_rgba_color(
		'input-bg-color',
		of_get_option( 'input_bg_color' ),
		of_get_option( 'input_bg_opacity' )
	);
	/**
	 * Stripes.
	 */
