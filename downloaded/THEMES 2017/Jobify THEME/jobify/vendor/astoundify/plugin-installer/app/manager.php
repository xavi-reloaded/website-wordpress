 ...
 * @since 1.0.0
 */
class Astoundify_PluginInstaller_Manager extends Astoundify_ModuleLoader_Module {
	...
	protected $modules = array(
		'activate' => 'Astoundify_PluginInstaller_Activate'
	);
	...
	public function load() {
		require_once( dirname( __FILE__ ) . '/astoundify-plugininstaller-functions.php' );
	}
