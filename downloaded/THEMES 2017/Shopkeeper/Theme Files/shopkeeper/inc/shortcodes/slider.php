...
function getbowtied_slider($params = array(), $content = null) {
	...
	if (!$hide_arrows):
			$getbowtied_slider .= '
				<div style="color: '. $color_navigation_arrows .'" class="swiper-button-prev"><i class="spk-icon-left-arrow-thin-large"></i></div>
    			<div style="color: '. $color_navigation_arrows .'" class="swiper-button-next"><i class="spk-icon-right-arrow-thin-large"></i></div>';
    endif;
