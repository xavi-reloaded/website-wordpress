...
function shopkeeper_custom_styles() {	
	...
	<style>
		...
		<?php //if ( (isset($shopkeeper_theme_options['main_font']['font-family'])) && (trim($shopkeeper_theme_options['main_font']['font-family']) != "" ) ) : ?>			
			...
			{ 
				font-family: 
				<?php if (!in_array($shopkeeper_theme_options['main_font']['font-family'], $default_fonts)): ?>
		...
		<?php //if ( (isset($shopkeeper_theme_options['secondary_font']['font-family'])) && (trim($shopkeeper_theme_options['secondary_font']['font-family']) != "" ) ) : ?>
			...
			{
				font-family: 
				<?php if (!in_array($shopkeeper_theme_options['secondary_font']['font-family'], $default_fonts)): ?>
					<?php echo '\'' . $shopkeeper_theme_options['secondary_font']['font-family'] . '\','; ?> 
					sans-serif;
				<?php else: ?>
					<?php echo $shopkeeper_theme_options['secondary_font']['font-family'] .', sans-serif'; ?> 
				<?php endif; ?>
			}			
		<?php //endif; ?>
		...
		.checkout_right_wrapper .order_review_wrapper .woocommerce-checkout-review-order-table tr td,
		.checkout_right_wrapper .order_review_wrapper .woocommerce-checkout-review-order-table ul li label,
		.checkout_right_wrapper .order_review_wrapper .woocommerce-checkout-payment ul li label,
		...
		.cd-quick-view .quantity.custom .minus-btn,
		.cd-quick-view .quantity.custom .plus-btn {
		  border: none;
		  color: #fff;
		  border-style: solid;
		  border-width: 2px;
		...
		.cd-quick-view .quantity.custom .minus-btn:hover,
		.cd-quick-view .quantity.custom .plus-btn:hover {
		  background: none !important;
		}
		...
		@media only screen and (max-width: 767px) {
			.product:not(.product-type-grouped) .quantity.custom .minus-btn,
		...
		<?php if ( isset($shopkeeper_theme_options['notification_style']) && $shopkeeper_theme_options['notification_style'] == "0") : ?>
		.woocommerce-message,
		.woocommerce-error,
		.woocommerce-info
		{
