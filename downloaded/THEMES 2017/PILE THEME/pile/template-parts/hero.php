...
<div id="djaxHero" <?php pile_hero_classes( $classes ); ?>>
	...
	<div class="hero js-hero bigger-fonts" <?php if ( ! pixelgrade_option( 'use_ajax_loading' ) ) {
		pile_the_background_color_style();
	} ?>>
		...
		if ( ! empty( $featured_projects_IDs ) ) {
			...
			foreach ( $query_posts as $post ) :
				...
				<div class="rsContent" <?php pile_the_background_color_style(); ?>>
					...
					pile_the_hero_description( $post, $link_project );
					?>
