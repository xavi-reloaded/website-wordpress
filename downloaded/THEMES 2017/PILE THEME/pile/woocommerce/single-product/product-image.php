...
<div class="images">
	...
	if ( ! empty( $attachment_ids ) ) {
		...
		echo '<div class="big-images">' . apply_filters( 'woocommerce_single_product_image_html', sprintf( '<img src="%s" alt="%s" />', wc_placeholder_img_src(), esc_html__( 'Placeholder', 'woocommerce' ) ), $post->ID ) . '</div><!-- .big-images -->' . PHP_EOL;
